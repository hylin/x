...
- - 🐛 Removed Bubble repeat type declare. [#1032](https://github.com/ant-design/x/pull/1032) by [@wzc520pyfm](https://github.com/wzc520pyfm).
- 🐛 Fixed Conversations onActiveChange be triggered when disabled menu item is clicked.[#1024](https://github.com/ant-design/x/pull/1024) by [@QdabuliuQ](https://github.com/QdabuliuQ).
